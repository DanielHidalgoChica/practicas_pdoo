...
public class Dice {
    ...
    /**
     * Gives a value for the intelligence
    ...
    /**
     * Gives a value for the strength
    ...
    public static boolean discardElement(int usesLeft){
        float bound = (MAX_USES-usesLeft)/MAX_USES;
        if (generator.nextFloat()<bound || usesLeft ==MAX_USES)
            return false;
        else
            return true;
    }
